      ...
      >
        <div className="h-screen font-serat">
          ...
          <div className="mt-6">
            ...
            <p
              data-aos="zoom-in"
              className="w-[240px] my-4 mx-auto text-center text-white font-bold text-lg lg:text-3xl"
            >
      ...
      <div className="bg-cover" style={{ backgroundImage: `url(${section6})` }}>
        <div className="h-screen">
          <div className="pt-80">
            <h1
              data-aos="fade-down"
              className="text-4xl font-crimsonPro text-white text-center w-[200px] mx-auto mb-8 lg:text-6xl"
            >
              Contact Person
            </h1>
            <div className="flex justify-center space-x-6">
              <a href="https://instagram.com/mpk12bandung?igshid=ZDdkNTZiNTM=">
                <img
                  data-aos="zoom-in"
                  src={ig}
                  alt=""
              ...
              <a href="https://wa.me/62821153108610">
                <img
                  data-aos="zoom-in"
                  src={wa}
                  alt=""
              ...
              <a href="https://line.me/ti/p/P-KYwumGLG">
                <img
                  data-aos="zoom-in"
                  src={line}
                  alt=""
